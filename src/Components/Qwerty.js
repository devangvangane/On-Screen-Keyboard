    ...
    <>
        ...
        <div className='numbers'>
            <div className='nonalphanumeric'>
                <button className='backtick' onClick={()=> handleButtonClick("`")}><sup>~ </sup>`</button>
            </div>
            <div>
                <button onClick={()=> handleButtonClick("1")}><sup>! </sup>1</button>
                <button onClick={()=> handleButtonClick("2")}><sup>@ </sup>2</button>
                <button onClick={()=> handleButtonClick("3")}><sup># </sup>3</button>
                <button onClick={()=> handleButtonClick("4")}><sup>$ </sup>4</button>
                <button onClick={()=> handleButtonClick("5")}><sup>% </sup>5</button>
                <button onClick={()=> handleButtonClick("6")}><sup>^ </sup>6</button>
                <button onClick={()=> handleButtonClick("7")}><sup>& </sup>7</button>
                <button onClick={()=> handleButtonClick("8")}><sup>* </sup>8</button>
                <button onClick={()=> handleButtonClick("9")}><sup>{"("} </sup>9</button>
                <button onClick={()=> handleButtonClick("0")}><sup>{")"} </sup>0</button>
            </div>
            <div className='nonalphanumeric'>
                <button onClick={()=> handleButtonClick("-")}><sup>_ </sup>-</button>
                <button onClick={()=> handleButtonClick("=")}><sup>+ </sup>=</button>
                <button className='backspace' onClick={()=> handleButtonClick("backspace")}>Backspace</button>
            </div>
        </div>
        <div className='qwerty'>
            <div className='nonalphanumeric'>
                <button className='tab' onClick={()=> handleButtonClick("1")}>Tab</button>
            </div>
        ...
        <div className='asdfg'>
            <div>
                <button className={`${styleC} capsl`} onClick={()=> {handleButtonClick("caps");
            changeCapslockButtonColor();}}>CapsLock</button>
            </div>
            <div className='alphanumeric'>
            ...
            <div className='nonalphanumeric'>
                <button onClick={()=> handleButtonClick(";")}><sup>: </sup>;</button>
                <button onClick={()=> handleButtonClick("'")}><sup>" </sup>'</button>
                <button className='enter' onClick={()=> handleButtonClick("enter")}>Enter</button>
            </div>
        </div>
        <div className='zxcvb'>
            <div className='nonalphanumeric'>
                <button className={`${style} shift l`} onClick={()=> {handleButtonClick("shift");
            changeShiftButtonColor();}}>Shift</button>
            </div>
            <div className='alphanumeric'>
            ...
            <div className='nonalphanumeric'> 
                ...
                <button onClick={()=> handleButtonClick(".")}><sup>{">"} </sup>.</button>
                <button onClick={()=> handleButtonClick("/")}><sup>? </sup>/</button>
                <button className={`${style} shift r`} onClick={()=> {handleButtonClick("shift");
            changeShiftButtonColor();}}>Shift</button>
            </div>
        </div>
        <div className='sb'>
            <button className='spacebar' onClick={()=> handleButtonClick("spacebar")}></button>
        </div>
    </>
  )
}
